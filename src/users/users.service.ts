...
export class UsersService {
    ...
    async createByAdminWithCustomer(dto: CreateUserWithCustomerDto) {
        ...
        if (exists) {
            throw new BadRequestException('Este e-mail já está em uso. Por favor, utilize outro endereço.');
        }
        ...
        if (!phone) {
            throw new BadRequestException('Telefone é obrigatório para criar o cadastro do cliente.');
        }
        ...
        const [items, total] = await this.prisma.$transaction([
            this.prisma.user.findMany({
                ...
                select: {
                    ...
                    customers: {
                        select: { id: true, type: true, accountStatus: true, phone: true, createdAt: true },
                    },
                },
            }),
